        ...
        <>
            <section className="finorg-info-block">
                <div className="finorg-left-block">
                    <h2 className="to-business-header">Финансовым организациям</h2>
                ...
                <div className="finorg-right-block">
                    <img src={toFinorgImage} alt="Финансовым организациям" width="335" height="426" className="finorg-info-block-image" />
                    <div className="finorg-be-partner-button">
                        <a href="#" className="page-button be-partner-button">
            ...
            <section className="why-we">
                ...
                <ul className="why-we-list why-we-list-finorg">
                    <li className="why-we-item why-we-item-finorg">
                    ...
                    <li className="why-we-item why-we-item-finorg">
                        <figure className="why-we-article">
                            ...
                            <figcaption className="why-we-caption">
                                <h4 className="why-we-article-header"Взаимодействие>Взаимодействие</h4>
